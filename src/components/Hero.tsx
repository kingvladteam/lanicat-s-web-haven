    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-dark">
      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Secondary Buttons Row - with slide-up from behind animation */}
          <div className="flex flex-col sm:flex-row items-center gap-3 mt-3 overflow-hidden">
            <a
              href="https://discord.gg/aWPSsuEzr3"
              className="inline-flex items-center gap-2 px-5 py-2.5 text-muted-foreground hover:text-primary 
                         border border-border/50 hover:border-primary/30 rounded-lg transition-all duration-300
                         animate-slide-up-delayed opacity-0"
      ...
      {/* Scroll indicator - now a tooltip with info */}
      <button 
      ...
      >
        <div className="w-8 h-12 rounded-full border-2 border-muted-foreground/50 flex flex-col items-center justify-center gap-1 hover:border-primary transition-colors group-hover:bg-primary/10">
