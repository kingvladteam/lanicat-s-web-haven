      ...
      <main className="py-16">
        <div className="container px-4 max-w-4xl mx-auto">
          ...
          <section className="mb-16">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">Lanicat є безкоштовним ботом і з самого початку створювався спеціально для українських спільнот. Основна ідея проєкту — надати українським серверам якісний, сучасний та універсальний інструмент без необхідності використання кількох різних ботів.</p>
          </section>
